$(document).ready(function () {
    ...
    let showModal = function (motive,articleName,email ,firstName,lastName,date,status,id) {
    ...
    let table = $('#datatable-category').DataTable({
        ...
        createdRow: function (row, data) {
            let actions = '<button style="margin-right: 5px" type="button" class="mb-1 btn btn-warning btn-pill edit-demand"><i class=" mdi mdi-pencil mr-1"></i></button>';
